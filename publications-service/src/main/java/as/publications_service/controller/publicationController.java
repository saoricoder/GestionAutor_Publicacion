...
public class publicationController {
    ...
    public ResponseEntity<Map<String, Object>> updateStatus(
        ...
        logger.info("PATCH /api/publications/{}/status - Actualizando a {}", id, request.getStatus());
        
        try {
            publicationResponseDTO publication = service.updateStatus(id, request.getStatus());
