    ...
    CommandLineRunner initDatabase(publicationRepository repository, RestTemplate restTemplate) {
        return args -> {
            ...
            if (authorIds.isEmpty()) {
                ...
                pub1.setAuthorId(authorIds.get(0));
                ...
                pub2.setAuthorId(authorIds.get(1));
                ...
                pub3.setAuthorId(authorIds.get(2));
                ...
                pub4.setAuthorId(authorIds.get(0));
                ...
                pub5.setAuthorId(authorIds.get(3 % authorIds.size()));
    ...
    private List<String> getAuthorIds(RestTemplate restTemplate) {
        try {
            ...
            if (response != null && response.containsKey("data")) {
                List<Map<String, Object>> authors = (List<Map<String, Object>>) response.get("data");
                List<String> ids = new ArrayList<>();
                
                for (Map<String, Object> author : authors) {
                    if (author.containsKey("idAuthor")) {
                        ids.add((String) author.get("idAuthor"));
                    }
                }
                
                logger.info("✅ Obtenidos {} autores de authors-service", ids.size());
                return ids;
            }
        } catch (Exception e) {
            logger.error("Error al obtener autores: {}", e.getMessage());
        }
